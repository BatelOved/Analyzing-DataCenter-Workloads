...
PROG_ARGS=(run --custom_malloc="@bazel_tools//tools/cpp:malloc" --config=clang --config=opt --define pfm=1)
#PROG_ARGS=(run --custom_malloc="@bazel_tools//tools/cpp:malloc" --config=gcc --config=opt --define pfm=1)
#PROG_ARGS=(run --custom_malloc="@bazel_tools//tools/cpp:malloc" --config=icx --config=opt --define pfm=1)
...
# BENCHMARK_ARGS+=(--benchmark_perf_counters=CYCLES,INSTRUCTIONS)
